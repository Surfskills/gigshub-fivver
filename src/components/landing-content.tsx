  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4">
        <div className="text-3xl transform transition-transform group-hover:scale-110 group-hover:rotate-3">{icon}</div>
        <div className="flex-1">
          <h3 className="font-bold text-[var(--text)] mb-1 group-hover:text-[var(--accent)] transition-colors">{title}</h3>
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-lg md:text-xl text-[var(--text-muted)] leading-relaxed">
                      Centralize gig tracking, reporting, and earnings management. Built for teams who need clarity and
                      control over multiple freelance accounts.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-8 border-t border-[var(--border)]">
                    <div>
                      <div className="text-2xl font-bold text-[var(--text)]" style={{ fontFamily: "'Space Mono', monospace" }}>
                        24/7
                      </div>
